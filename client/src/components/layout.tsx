...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-transparent">
      {/* Sidebar */}
      <aside className="w-56 card-glass border-r border-white/10 flex flex-col relative overflow-hidden">
            {/* Header with Logo */}
            <div className="relative p-4 pb-3">
              ...
              <div className="relative flex items-center justify-center">
                <div className="flex-shrink-0">
                  <img src={clinoLogo} alt="Clino Health" className="h-16 w-auto" />
                </div>
              </div>
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <header className="h-18 card-glass border-b border-white/10 flex items-center justify-between px-6 relative overflow-hidden">
          {/* Background decoration */}
      ...
      >
        <motion.button
          className="relative w-16 h-16 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl shadow-2xl flex items-center justify-center text-white overflow-hidden group"
          whileHover={{ 
            scale: 1.1, 
            rotate: [0, -10, 10, 0],
        ...
        >
          {/* Background glow */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-400/20 via-purple-400/20 to-pink-400/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-300" />
