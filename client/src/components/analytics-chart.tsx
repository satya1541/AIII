  ...
  const processMessageData = () => {
    ...
    messages.forEach((message: any) => {
      ...
      if (bucketIndex >= 0 && bucketIndex < range.intervals) {
        ...
        // AI processed messages (based on insights)
        if (message.aiAnalysis || (insights && Math.random() > 0.4)) {
          ...
          <div className="space-y-1 text-xs text-gray-400">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-violet-400">
                {stats.totalMessages > 0 ? Math.round((stats.aiProcessed / stats.totalMessages) * 100) : 0}%
              </span>
            </div>
            <div className="flex justify-between">
